...
class Plotter:
    def __init__(self, class_names, model_type):
        self.class_names = class_names
        self.model_type = model_type

    def plot_metrics(self, history, path_file='metrics.png'):
        ...
        plt.savefig(self.model_type+'_'+path_file)
        plt.show()
        plt.close()
    ...
    def plot_accuracy(self, history, path_file='accuracy.png'):
    ...
    def plot_output(self, test_predictions_baseline, y_test, x_test_drawing, test_run):
        ...
        plt.savefig(self.model_type+'_'+test_run)
        plt.show()
    ...
    def plot_confusion_matrix(self, y_true, y_pred, classes=None, normalize=False, title=None, cmap=plt.cm.Greens):
        """
        ...
        fig, ax = plt.subplots(fig_size=(8,12))
    ...
    def plot_confusion_matrix_generic(self, y_true, predictions, path_file='confusion_matrix.png'):
        cm = confusion_matrix( y_true.argmax(axis=1), predictions.argmax(axis=1))
        plt.figure(figsize=(10, 10))
